...
class SCDButil:
    ...
    color_dict = { ('mscb323_Temp_P1', 0):ROOT.kRed, 
                   ...
                   ('mscb110_Temp_P1', 7):ROOT.kOrange,
    ...
    subchannel_dict['computer_room'] = [ ('mscb110_Temp_P1', 0), ('mscb110_Temp_P1', 1), ('mscb110_Temp_P1', 2), ('mscb110_Temp_P1', 3), ('mscb110_Temp_P1', 4), ('mscb110_Temp_P1', 5), ('mscb110_Temp_P1', 6), ('mscb110_Temp_P1', 7) ]
